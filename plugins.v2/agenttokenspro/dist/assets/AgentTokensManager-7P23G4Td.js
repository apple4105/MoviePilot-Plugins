...
import { _ as _export_sfc, f as formatTokens, P as PROVIDER_TYPE_OPTIONS, n as normalizeModelOptions, a as createProvider, b as buildProviderRows, d as buildProviderSummary, g as getNextProviderPriority, e as normalizeProvider } from './_plugin-vue_export-helper-dmbiuH_o.js';

const {openBlock:_openBlock$4,createElementBlock:_createElementBlock$3,createCommentVNode:_createCommentVNode$3,createElementVNode:_createElementVNode$4,renderList:_renderList$1,Fragment:_Fragment$2,resolveComponent:_resolveComponent$4,createVNode:_createVNode$4,toDisplayString:_toDisplayString$4,withModifiers:_withModifiers$1,normalizeClass:_normalizeClass$1,createTextVNode:_createTextVNode$4,withCtx:_withCtx$4,unref:_unref$4,createBlock:_createBlock$4} = await importShared('vue');
...
const _hoisted_5$4 = ["draggable", "onClick", "onDragstart", "onDragover", "onDrop"];
const _hoisted_6$4 = {
  key: 0,
...
ref$2(null);
ref$2(null);
const dragIndex = ref$2(-1);
const dragOverIndex = ref$2(-1);
          ...
          default: _withCtx$4(() => [
            _createElementVNode$4("thead", null, [
              _createElementVNode$4("tr", null, [
                (__props.dragMode)
                  ? (_openBlock$4(), _createElementBlock$3("th", _hoisted_2$4))
                ...
                _cache[5] || (_cache[5] = _createElementVNode$4("th", null, "名称", -1)),
                _cache[6] || (_cache[6] = _createElementVNode$4("th", null, "类型", -1)),
                (__props.showCredentials)
                  ? (_openBlock$4(), _createElementBlock$3("th", _hoisted_3$4, "地址"))
                  : _createCommentVNode$3("", true),
                (__props.showCredentials)
                  ? (_openBlock$4(), _createElementBlock$3("th", _hoisted_4$4, "Key"))
                  : _createCommentVNode$3("", true),
                _cache[7] || (_cache[7] = _createElementVNode$4("th", null, "代理", -1)),
                _cache[8] || (_cache[8] = _createElementVNode$4("th", null, "模型", -1)),
                _cache[9] || (_cache[9] = _createElementVNode$4("th", null, "额度", -1)),
                _cache[10] || (_cache[10] = _createElementVNode$4("th", { class: "text-right" }, "操作", -1))
              ])
            ]),
            _createElementVNode$4("tbody", null, [
              (_openBlock$4(true), _createElementBlock$3(_Fragment$2, null, _renderList$1(__props.providers, (row, index) => {
                return (_openBlock$4(), _createElementBlock$3("tr", {
                  key: row.id || index,
                  draggable: __props.dragMode,
                  class: _normalizeClass$1([rowClasses(row, index), "clickable-row"]),
                  ...
                  (__props.dragMode)
                    ? (_openBlock$4(), _createElementBlock$3("td", _hoisted_6$4, [
                  ...
                  'provider-disabled': !row.enabled,
                    ...
                    }, _toDisplayString$4(row.enabled && isActive(row) ? '⚡' : '○'), 11, _hoisted_7$4)
                  ]),
                  _createElementVNode$4("td", {
                  ...
                  (__props.showCredentials)
                    ? (_openBlock$4(), _createElementBlock$3("td", _hoisted_8$4, _toDisplayString$4(row.base_url), 1))
                    : _createCommentVNode$3("", true),
                  (__props.showCredentials)
                    ? (_openBlock$4(), _createElementBlock$3("td", _hoisted_9$3, _toDisplayString$4(getMaskedApiKey(index)), 1))
                    : _createCommentVNode$3("", true),
              ...
              (!__props.providers.length)
                ? (_openBlock$4(), _createElementBlock$3("tr", _hoisted_10$3, [
                    _createElementVNode$4("td", {
                      colspan: __props.showCredentials ? 11 : 9,
                      class: "text-center text-medium-emphasis py-8"
                    }, "暂无供应商", 8, _hoisted_11$3)
                  ]))
                : _createCommentVNode$3("", true)
            ])
          ]),
...
const ProviderConfigTable = /*#__PURE__*/_export_sfc(_sfc_main$4, [['__scopeId',"data-v-55d0a21d"]]);

const {toDisplayString:_toDisplayString$3,createElementVNode:_createElementVNode$3,resolveComponent:_resolveComponent$3,createVNode:_createVNode$3,createTextVNode:_createTextVNode$3,withModifiers:_withModifiers,withCtx:_withCtx$3,unref:_unref$3,openBlock:_openBlock$3,createBlock:_createBlock$3,createCommentVNode:_createCommentVNode$2,createElementBlock:_createElementBlock$2,Fragment:_Fragment$1} = await importShared('vue');
...
const clipboardHint = ref$1('');
const clipboardHintColor = ref$1('info');
const showPasteDialog = ref$1(false);
const pasteText = ref$1('');
...
function parseAndFill(text) {
  ...
  // 3. 格式校验
  if (!url || !key) {
    showClipboard('格式不正确，请确保文本包含 Base URL 和 API Key', 'error', 4000);
    return false
  }
...
// 获取到模型后自动选中第一个（单模型直接选中，多模型选中第一个）。
async function queryModels() {
  ...
  try {
    ...
    if (!options.length) {
      ...
      // 自动选中第一个模型：同步到 provider.model 确保提交时不为空
      const first = options[0];
      props.provider.model = first.value || first.title || '';
    }
  } catch (err) {
...
return (_ctx, _cache) => {
  ...
  return (_openBlock$3(), _createElementBlock$2(_Fragment$1, null, [
            ...
            _createVNode$3(_component_VCardTitle, { class: "d-flex align-center" }, {
              default: _withCtx$3(() => [
                ...
                _createVNode$3(_component_VBtn, {
                  ...
                  color: "primary",
                  class: "mr-2",
                  onClick: _withModifiers(importFromClipboard, ["stop"])
                }, {
                  default: _withCtx$3(() => [...(_cache[18] || (_cache[18] = [
                    _createTextVNode$3(" 剪贴板导入 ", -1)
                  ]))]),
                  _: 1
                }),
                _createVNode$3(_component_VBtn, {
            ...
            _createVNode$3(_component_VCardText, null, {
              default: _withCtx$3(() => [
                _createElementVNode$3("div", _hoisted_1$3, [
                  _cache[19] || (_cache[19] = _createElementVNode$3("span", { class: "form-label" }, "名称", -1)),
                ...
                _createElementVNode$3("div", _hoisted_2$3, [
                  _cache[20] || (_cache[20] = _createElementVNode$3("span", { class: "form-label" }, "优先级", -1)),
                  _createVNode$3(_component_VTextField, {
                ...
                _createElementVNode$3("div", _hoisted_3$3, [
                  _cache[21] || (_cache[21] = _createElementVNode$3("span", { class: "form-label" }, "类型", -1)),
                ...
                _createElementVNode$3("div", _hoisted_7$3, [
                  _cache[22] || (_cache[22] = _createElementVNode$3("span", { class: "form-label" }, "API 地址", -1)),
                  _createVNode$3(_component_VTextField, {
                ...
                _createElementVNode$3("div", _hoisted_8$3, [
                  _cache[23] || (_cache[23] = _createElementVNode$3("span", { class: "form-label" }, "API Key", -1)),
                ...
                _createElementVNode$3("div", _hoisted_10$2, [
                  _cache[24] || (_cache[24] = _createElementVNode$3("span", { class: "form-label" }, "User-Agent", -1)),
                  _createVNode$3(_component_VTextField, {
                    modelValue: __props.provider.user_agent,
                    "onUpdate:modelValue": _cache[8] || (_cache[8] = $event => ((__props.provider.user_agent) = $event)),
                    variant: "outlined",
                    "hide-details": ""
                  }, null, 8, ["modelValue"])
                ]),
                _createElementVNode$3("div", _hoisted_11$2, [
                  _cache[25] || (_cache[25] = _createElementVNode$3("span", { class: "form-label" }, "使用代理", -1)),
                  _createVNode$3(_component_VSwitch, {
                    modelValue: __props.provider.use_proxy,
                    "onUpdate:modelValue": _cache[9] || (_cache[9] = $event => ((__props.provider.use_proxy) = $event)),
                    color: "primary",
                    "hide-details": "",
                    density: "compact"
                  }, null, 8, ["modelValue"])
                ...
                _createElementVNode$3("div", _hoisted_12$2, [
                  _createElementVNode$3("div", _hoisted_13$1, [
                    _cache[26] || (_cache[26] = _createElementVNode$3("span", { class: "form-label" }, "Token 额度", -1)),
                    _createVNode$3(_component_VTextField, {
                      modelValue: __props.provider.token_limit,
                      "onUpdate:modelValue": _cache[10] || (_cache[10] = $event => ((__props.provider.token_limit) = $event)),
                      modelModifiers: { number: true },
                      type: "number",
                      variant: "outlined",
                      "hide-details": ""
                  ...
                  _createElementVNode$3("div", _hoisted_14$1, [
                    _cache[27] || (_cache[27] = _createElementVNode$3("span", { class: "form-label" }, "初始已用", -1)),
                    _createVNode$3(_component_VTextField, {
                      modelValue: __props.provider.used_tokens,
                      "onUpdate:modelValue": _cache[11] || (_cache[11] = $event => ((__props.provider.used_tokens) = $event)),
                      modelModifiers: { number: true },
                      type: "number",
                      variant: "outlined",
                      "hide-details": ""
            ...
            (testResult.value)
              ? (_openBlock$3(), _createElementBlock$2("div", _hoisted_15$1, [
                  _createVNode$3(_component_VAlert, {
                    ...
                    density: "compact",
                    closable: "",
                    "onClick:close": _cache[12] || (_cache[12] = $event => (testResult.value = null))
                  }, {
                    default: _withCtx$3(() => [
    ...
    _createVNode$3(_component_VSnackbar, {
      ...
      variant: "tonal",
      "onUpdate:modelValue": _cache[14] || (_cache[14] = v => { if (!v) clipboardHint.value = ''; })
    }, {
      default: _withCtx$3(() => [
        _createTextVNode$3(_toDisplayString$3(clipboardHint.value), 1)
      ]),
      _: 1
    }, 8, ["model-value", "color"]),
    _createVNode$3(_component_VDialog, {
      modelValue: showPasteDialog.value,
      "onUpdate:modelValue": _cache[17] || (_cache[17] = $event => ((showPasteDialog).value = $event)),
      "max-width": "520",
      persistent: ""
    }, {
      default: _withCtx$3(() => [
        _createVNode$3(_component_VCard, null, {
          default: _withCtx$3(() => [
            _createVNode$3(_component_VCardTitle, { class: "text-subtitle-1" }, {
              default: _withCtx$3(() => [...(_cache[30] || (_cache[30] = [
                _createTextVNode$3("手动粘贴配置", -1)
              ]))]),
              _: 1
            }),
            _createVNode$3(_component_VCardText, null, {
              default: _withCtx$3(() => [
                _createVNode$3(_component_VAlert, {
                  ...
                  default: _withCtx$3(() => [...(_cache[31] || (_cache[31] = [
                    _createTextVNode$3(" 浏览器已拦截剪贴板直接读取，请在下方粘贴配置文本 ", -1)
                  ]))]),
                  _: 1
                }),
                _createVNode$3(_component_VTextarea, {
                  modelValue: pasteText.value,
                  "onUpdate:modelValue": _cache[15] || (_cache[15] = $event => ((pasteText).value = $event)),
                  variant: "outlined",
                  placeholder: "Base URL: https://xxx\nAPI Key: sk-xxxx",
                  rows: "5",
                  "auto-grow": "",
                  "hide-details": ""
                }, null, 8, ["modelValue"])
            ...
            _createVNode$3(_component_VCardActions, { class: "d-flex justify-end ga-2" }, {
              default: _withCtx$3(() => [
                _createVNode$3(_component_VBtn, {
                  variant: "text",
                  onClick: _cache[16] || (_cache[16] = $event => (showPasteDialog.value = false))
                }, {
                ...
                _createVNode$3(_component_VBtn, {
                  ...
                  default: _withCtx$3(() => [...(_cache[33] || (_cache[33] = [
                    _createTextVNode$3("解析填入", -1)
                  ]))]),
                  _: 1
                }, 8, ["disabled"])
              ]),
...
const ProviderEditorDialog = /*#__PURE__*/_export_sfc(_sfc_main$3, [['__scopeId',"data-v-5db9e741"]]);
...
const ProviderUsageTable = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-da342629"]]);
...
function commitProvider() {
  ...
  // 通过 emit 通知父组件更新，避免直接修改 prop 导致响应式丢失
  emit('update-providers', nextProviders);
  showEditor.value = false;
  emit('auto-save');
}
...
function toggleProvider(index) {
  ...
  // 创建新数组触发响应式更新
  const nextProviders = [...providers.value];
  nextProviders[index] = { ...provider, enabled: !provider.enabled };
  emit('update-providers', nextProviders);
  emit('auto-save');
}
...
function selectProvider(providerId) {
  ...
  // 将选中供应商移到列表首位（置顶）
  const idx = providers.value.findIndex(p => p.id === resolvedId);
  if (idx > 0) {
    // 创建新数组并赋值，确保 Vue 能检测到变化
    const nextProviders = [...providers.value];
    const [moved] = nextProviders.splice(idx, 1);
    nextProviders.unshift(moved);
    // 使用 emit 通知父组件更新，而不是直接修改 prop
    emit('update-providers', nextProviders);
  }
  emit('select-provider', resolvedId);
}

// 拖拽排序：将 from 位置的供应商移到 to 位置，立即保存。
function reorderProvider(from, to) {
  const nextProviders = [...providers.value];
  const [moved] = nextProviders.splice(from, 1);
  nextProviders.splice(to, 0, moved);
  emit('update-providers', nextProviders);
  emit('auto-save');
}

// 切换拖拽模式，退出时自动保存新顺序（由 ProviderConfigTable 的 save-draft 事件驱动）。
...
const AgentTokensManager = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-e26824ef"]]);
