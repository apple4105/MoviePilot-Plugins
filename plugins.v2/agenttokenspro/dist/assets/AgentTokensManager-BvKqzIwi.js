...
const _hoisted_3$5 = ["draggable", "onDragstart", "onDragover", "onDrop"];
  ...
  return (_openBlock$5(), _createBlock$5(_component_VSheet, {
    ...
    default: _withCtx$5(() => [
      _createElementVNode$5("div", {
        class: _normalizeClass$4(["provider-table-scroll", { 'is-drag-mode': __props.dragMode }])
      }, [
        _createVNode$5(_component_VTable, { density: "comfortable" }, {
          default: _withCtx$5(() => [
            ...
            _createElementVNode$5("tbody", null, [
              (_openBlock$5(true), _createElementBlock$4(_Fragment$4, null, _renderList$3(sortedProviders.value, (row, index) => {
                return (_openBlock$5(), _createElementBlock$4("tr", {
                  key: row.id || index,
                  draggable: __props.dragMode,
                  class: _normalizeClass$4([rowClasses(row), "provider-row"]),
                  ...
                  _createElementVNode$5("td", {
                    ...
                    _createElementVNode$5("div", _hoisted_6$5, [
                      _createElementVNode$5("span", {
                        class: _normalizeClass$4(['status-dot', row.enabled ? 'active' : 'inactive'])
                      }, null, 2)
                    ])
                  ], 8, _hoisted_5$5),
                  _createElementVNode$5("td", _hoisted_7$5, [
                    _createElementVNode$5("span", {
                ...
                'provider-name--misconfigured': !isFaulty(row) && !isCooldown(row) && isMisconfigured(row),
                  ...
                  (__props.showCredentials)
                    ? (_openBlock$5(), _createElementBlock$4("td", _hoisted_9$5, _toDisplayString$5(row.base_url), 1))
                    : _createCommentVNode$4("", true),
                  (__props.showCredentials)
                  ...
                  _createElementVNode$5("td", {
                    ...
                    _createVNode$5(_component_VTooltip, { location: "top" }, {
                      activator: _withCtx$5(({ props: tooltipProps }) => [
                        _createVNode$5(_component_VBtn, _mergeProps$2({ ref_for: true }, tooltipProps, {
...
const ProviderConfigTable = /*#__PURE__*/_export_sfc(_sfc_main$5, [['__scopeId',"data-v-92d60609"]]);
...
const _hoisted_6$4 = { class: "form-item" };
const _hoisted_7$4 = { class: "form-label" };
const _hoisted_8$4 = { class: "input-group" };
const _hoisted_9$4 = { class: "form-item" };
...
const _sfc_main$4 = {
  ...
  emits: ['update:modelValue', 'commit', 'query-models', 'test-connection', 'delete'],
  setup(__props, { emit: __emit }) {
...
const modelOptions = ref$3([]);
const loadingModels = ref$3(false);
const testingConnection = ref$3(false);
const modelError = ref$3('');
const testResult = ref$3(null);
const connectionTestState = ref$3(null);
const showApiKey = ref$3(false);
const clipboardHint = ref$3('');
const clipboardHintColor = ref$3('info');
const showPasteDialog = ref$3(false);
const pasteText = ref$3('');
...
return (_ctx, _cache) => {
  const _component_VFadeTransition = _resolveComponent$4("VFadeTransition");
  ...
  return (_openBlock$4(), _createElementBlock$3(_Fragment$3, null, [
          ...
          default: _withCtx$4(() => [
            _createVNode$4(_component_VCardTitle, { class: "d-flex align-center" }, {
              default: _withCtx$4(() => [
                ...
                _createVNode$4(_component_VFadeTransition, null, {
                  default: _withCtx$4(() => [
                    (clipboardHint.value)
                      ? (_openBlock$4(), _createElementBlock$3("span", {
                          key: 0,
                          class: _normalizeClass$3(["ml-2 text-caption", clipboardHintColor.value === 'error' ? 'text-error' : clipboardHintColor.value === 'success' ? 'text-success' : clipboardHintColor.value === 'warning' ? 'text-warning' : 'text-info'])
                        }, _toDisplayString$4(clipboardHint.value), 3))
                ...
                (isEdit.value)
                  ? (_openBlock$4(), _createBlock$4(_component_VBtn, {
                      ...
                      color: "error",
                      class: "mr-2",
                      onClick: _withModifiers$2(handleDelete, ["stop"])
                    }, {
                ...
                _createVNode$4(_component_VBtn, {
                  ...
                  color: "primary",
                  class: "mr-2",
                  onClick: _withModifiers$2(importFromClipboard, ["stop"])
                }, {
                ...
                _createElementVNode$4("div", _hoisted_4$4, [
                  ...
                  _createElementVNode$4("div", _hoisted_5$4, [
                    _createVNode$4(_component_VTextField, {
                      ...
                      "onUpdate:modelValue": _cache[4] || (_cache[4] = $event => ((__props.provider.api_key) = $event)),
                    ...
                    (isEdit.value)
                      ? (_openBlock$4(), _createBlock$4(_component_VBtn, {
                          ...
                          onClick: _cache[5] || (_cache[5] = _withModifiers$2($event => (showApiKey.value = !showApiKey.value), ["stop"]))
                        }, null, 8, ["icon"]))
                      : _createCommentVNode$3("", true)
                  ])
                ]),
                _createElementVNode$4("div", _hoisted_6$4, [
                  _createElementVNode$4("span", _hoisted_7$4, _toDisplayString$4(modelCountText.value), 1),
                  _createElementVNode$4("div", _hoisted_8$4, [
                    ...
                    _createVNode$4(_component_VBtn, {
                      ...
                      loading: loadingModels.value,
                      class: "input-action-btn",
                      onClick: _withModifiers$2(queryModels, ["stop"])
                    }, null, 8, ["loading"])
                  ])
                ]),
                _createElementVNode$4("div", _hoisted_9$4, [
    ...
    _createVNode$4(_component_VDialog, {
      ...
      "onUpdate:modelValue": _cache[15] || (_cache[15] = $event => ((showPasteDialog).value = $event)),
      "max-width": "520",
      persistent: ""
    }, {
      default: _withCtx$4(() => [
          ...
          default: _withCtx$4(() => [
            ...
            _createVNode$4(_component_VCardText, null, {
              default: _withCtx$4(() => [
                ...
                _createVNode$4(_component_VTextarea, {
                  ...
                  "onUpdate:modelValue": _cache[13] || (_cache[13] = $event => ((pasteText).value = $event)),
                  variant: "outlined",
            ...
            _createVNode$4(_component_VCardActions, { class: "d-flex justify-end ga-2" }, {
              default: _withCtx$4(() => [
                _createVNode$4(_component_VBtn, {
                  variant: "text",
                  onClick: _cache[14] || (_cache[14] = $event => (showPasteDialog.value = false))
                }, {
...
const ProviderEditorDialog = /*#__PURE__*/_export_sfc(_sfc_main$4, [['__scopeId',"data-v-b2133699"]]);

const {createElementVNode:_createElementVNode$3,renderList:_renderList$2,Fragment:_Fragment$2,openBlock:_openBlock$3,createElementBlock:_createElementBlock$2,resolveComponent:_resolveComponent$3,createVNode:_createVNode$3,createCommentVNode:_createCommentVNode$2,toDisplayString:_toDisplayString$3,normalizeClass:_normalizeClass$2,unref:_unref$2,createTextVNode:_createTextVNode$3,mergeProps:_mergeProps$1,withCtx:_withCtx$3,createBlock:_createBlock$3,withModifiers:_withModifiers$1} = await importShared('vue');
...
const _hoisted_9$3 = { class: "progress-cell" };
...
const {computed: computed$3,ref: ref$2,onMounted: onMounted$2,onUnmounted} = await importShared('vue');
...
const testingId = ref$2(null);

// 冷却倒计时：每秒更新的时间基准，驱动 cooldownRemaining 响应式刷新
const now = ref$2(Date.now());
let _nowTimer = null;
onMounted$2(() => {
          ...
          default: _withCtx$3(() => [
            _cache[2] || (_cache[2] = _createElementVNode$3("thead", null, [
              _createElementVNode$3("tr", null, [
                ...
                _createElementVNode$3("th", { class: "text-right col-actions-header" }, "操作")
              ])
            ], -1)),
            _createElementVNode$3("tbody", null, [
              ...
              'provider-row--failed': isFailed(row),
                  ...
                  _createElementVNode$3("td", _hoisted_9$3, [
                    ...
                    (row.usage?.last_error)
                      ? (_openBlock$3(), _createBlock$3(_component_VTooltip, {
                          ...
                          activator: _withCtx$3(({ props: tooltipProps }) => [
                            _createElementVNode$3("span", _mergeProps$1({ ref_for: true }, tooltipProps, { class: "text-error text-truncate d-inline-block error-text" }), _toDisplayString$3(row.usage.last_error), 17)
                          ]),
                          default: _withCtx$3(() => [
...
const ProviderUsageTable = /*#__PURE__*/_export_sfc(_sfc_main$3, [['__scopeId',"data-v-feffb9a8"]]);
...
const _hoisted_3$2 = { class: "usage-overview-card__chart-inner" };
const _hoisted_4$2 = { class: "usage-overview-card__percent" };
const _hoisted_5$2 = { class: "usage-overview-card__body" };
const _hoisted_6$2 = { class: "usage-overview-card__title-row" };
const _hoisted_7$2 = { class: "usage-overview-card__headline" };
const _hoisted_8$2 = { class: "text-medium-emphasis" };
const _hoisted_9$2 = { class: "usage-overview-card__meta" };
        ...
        _createElementVNode$2("div", _hoisted_2$2, [
          _createElementVNode$2("div", _hoisted_3$2, [
            _createVNode$2(_component_VProgressCircular, {
              ...
              default: _withCtx$2(() => [
                _createElementVNode$2("div", _hoisted_4$2, _toDisplayString$2(totalLimit.value > 0 ? usagePercentText.value : '不限'), 1)
              ]),
              _: 1
            }, 8, ["model-value", "color"])
          ])
        ...
        _createElementVNode$2("div", _hoisted_5$2, [
          _createElementVNode$2("div", _hoisted_6$2, [
            ...
            _createElementVNode$2("div", _hoisted_7$2, [
              ...
              _createElementVNode$2("span", _hoisted_8$2, "/ " + _toDisplayString$2(totalLimit.value > 0 ? _unref$1(formatTokens)(totalLimit.value) : '不限'), 1)
            ])
          ]),
...
const UsageOverviewCard = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-eb8515ea"]]);
...
const {computed: computed$1,ref: ref$1,watch: watch$1,onMounted: onMounted$1,nextTick: nextTick$1} = await importShared('vue');
...
// 删除确认弹窗
const showDeleteConfirm = ref$1(false);
const deleteVendorId = ref$1(null);
const deleteVendorName = ref$1('');
...
return (_ctx, _cache) => {
  ...
  return (_openBlock$1(), _createElementBlock$1("div", _hoisted_1$1, [
                      ...
                      (editingId.value === vendor.id)
                        ...
                        : (_openBlock$1(), _createElementBlock$1(_Fragment$1, { key: 1 }, [
                            ...
                            _createVNode$1(_component_VBtn, {
                              ...
                              variant: "text",
                              color: "error",
                              onClick: $event => (requestDeleteVendor(vendor))
                            }, null, 8, ["onClick"])
                          ], 64))
                    ])
                  ], 42, _hoisted_3$1))
    ...
    _createVNode$1(_component_VDialog, {
      ...
      "onUpdate:modelValue": _cache[6] || (_cache[6] = $event => ((showDeleteConfirm).value = $event)),
      "max-width": "420",
      persistent: ""
    }, {
      default: _withCtx$1(() => [
        _createVNode$1(_component_VCard, null, {
          default: _withCtx$1(() => [
            ...
            _createVNode$1(_component_VCardText, null, {
              default: _withCtx$1(() => [
                _cache[12] || (_cache[12] = _createTextVNode$1(" 确定要删除厂商「", -1)),
                _createElementVNode$1("strong", null, _toDisplayString$1(deleteVendorName.value), 1),
                _cache[13] || (_cache[13] = _createTextVNode$1("」吗？此操作不可撤销。 ", -1))
              ]),
              _: 1
            }),
            _createVNode$1(_component_VCardActions, { class: "d-flex justify-end ga-2" }, {
              default: _withCtx$1(() => [
                _createVNode$1(_component_VBtn, {
                  variant: "text",
                  onClick: _cache[5] || (_cache[5] = $event => (showDeleteConfirm.value = false))
                }, {
...
const VendorManager = /*#__PURE__*/_export_sfc(_sfc_main$1, [['__scopeId',"data-v-0eec1d3a"]]);
...
const _hoisted_12 = { class: "agenttokens-stat-card__label-row" };
const _hoisted_13 = { class: "agenttokens-stat-card__value-row" };
const _hoisted_14 = { class: "agenttokens-stat-card__value" };
const _hoisted_15 = { class: "agenttokens-stat-card__hint" };
const _hoisted_16 = {
  key: 0,
  class: "mobile-nav-bar"
};
const _hoisted_17 = { class: "mobile-tabs" };
const _hoisted_18 = ["onClick"];
const _hoisted_19 = { class: "mobile-actions" };
const _hoisted_20 = {
  key: 1,
  class: "agenttokens-tabs-row"
};
const _hoisted_21 = { class: "agenttokens-table-actions" };
...
__expose({ failedProviderIds, testFeedback });
  ...
  return (_openBlock(), _createElementBlock("div", {
    ...
    (!__props.hideTitle)
      ? (_openBlock(), _createElementBlock("div", _hoisted_1, [
          _cache[20] || (_cache[20] = _createElementVNode("h2", { class: "text-2xl font-bold leading-7 text-gray-100 truncate sm:text-3xl sm:leading-9" }, [
      ...
      default: _withCtx(() => [
        _createElementVNode("div", _hoisted_2, [
          _createElementVNode("div", _hoisted_3, [
            _cache[21] || (_cache[21] = _createElementVNode("span", { class: "switch-label" }, "启用插件", -1)),
          ...
          _createElementVNode("div", _hoisted_4, [
            _cache[22] || (_cache[22] = _createElementVNode("span", { class: "switch-label" }, "侧边栏入口", -1)),
            _createVNode(_component_VSwitch, {
        ...
        _createElementVNode("div", _hoisted_5, [
          _createElementVNode("div", _hoisted_6, [
            _createElementVNode("div", _hoisted_7, [
              ...
              _cache[23] || (_cache[23] = _createElementVNode("span", null, "限量总额度", -1))
            ]),
          ...
          _createElementVNode("div", _hoisted_9, [
            _cache[24] || (_cache[24] = _createElementVNode("span", { class: "config-label" }, "失败切换阈值", -1)),
    ...
    _createElementVNode("div", _hoisted_10, [
      _createVNode(UsageOverviewCard, {
        ...
        onResetTotal: _cache[5] || (_cache[5] = $event => (emit('reset-total')))
      }, null, 8, ["summary"]),
      _createVNode(_component_VSheet, {
        border: "",
        rounded: "",
        ...
        default: _withCtx(() => [
          ...
          _createElementVNode("div", null, [
            _cache[25] || (_cache[25] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "可用供应商", -1)),
        ...
        default: _withCtx(() => [
          ...
          _createElementVNode("div", null, [
            _createElementVNode("div", _hoisted_12, [
              _cache[28] || (_cache[28] = _createElementVNode("span", { class: "text-caption text-medium-emphasis" }, "累计使用", -1)),
              _createVNode(_component_VTooltip, { location: "top" }, {
                activator: _withCtx(({ props: tooltipProps }) => [
                  _createVNode(_component_VBtn, _mergeProps(tooltipProps, {
                    ...
                    onClick: _cache[6] || (_cache[6] = $event => (emit('reset-total')))
                  }), {
                    default: _withCtx(() => [
                      _createVNode(_component_VIcon, { size: "14" }, {
                ...
                default: _withCtx(() => [
                  _cache[27] || (_cache[27] = _createElementVNode("span", null, "重置总量（不影响各供应商用量记录）", -1))
                ]),
                _: 1
              })
            ]),
            _createElementVNode("div", _hoisted_13, [
              _createElementVNode("span", _hoisted_14, _toDisplayString(_unref(formatTokens)(Number(displaySummary.value.limited_used ?? displaySummary.value.total_used ?? 0))), 1)
            ]),
            _createElementVNode("div", _hoisted_15, " 限量 " + _toDisplayString(_unref(formatTokens)(limitedUsed.value)) + " / 不限量 " + _toDisplayString(_unref(formatTokens)(unlimitedUsed.value)), 1)
          ])
        ]),
        _: 1
      })
      ...
      default: _withCtx(() => [
        (testFeedback.value.show)
          ? (_openBlock(), _createBlock(_component_VAlert, {
              ...
              class: "my-2",
              closable: "",
              "onClick:close": _cache[7] || (_cache[7] = $event => (testFeedback.value.show = false))
            }, {
              default: _withCtx(() => [
    ...
    _createVNode(_component_VSheet, {
      ...
      default: _withCtx(() => [
          ...
          ? (_openBlock(), _createElementBlock("div", _hoisted_16, [
              _createElementVNode("div", _hoisted_17, [
                (_openBlock(), _createElementBlock(_Fragment, null, _renderList(mobileTabs, (tab) => {
                  ...
                  }, _toDisplayString(tab.label), 11, _hoisted_18)
                }), 64))
              ]),
                  ...
                  ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [
                      _createVNode(_component_VBtn, {
                        ...
                        default: _withCtx(() => [
                          ...
                          _cache[30] || (_cache[30] = _createElementVNode("span", null, "导出", -1))
                        ]),
                        _: 1
                      }),
                      _createVNode(_component_VBtn, {
                        ...
                        default: _withCtx(() => [
                          ...
                          _cache[32] || (_cache[32] = _createElementVNode("span", null, "导入", -1))
                        ]),
                        _: 1
                      }),
                  ...
                  ? (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [
                      _createVNode(_component_VBtn, {
                        ...
                        default: _withCtx(() => [
                          ...
                          _cache[34] || (_cache[34] = _createElementVNode("span", null, "新增", -1))
                        ]),
                        _: 1
                      }),
                      _createVNode(_component_VBtn, {
                      ...
                      _createVNode(_component_VBtn, {
                        ...
                        default: _withCtx(() => [
                          ...
                          _cache[37] || (_cache[37] = _createElementVNode("span", null, "重置", -1))
                        ]),
                        _: 1
                      })
                    ], 64))
                  ...
                  ? (_openBlock(), _createElementBlock(_Fragment, { key: 2 }, [
                      _createVNode(_component_VBtn, {
                        ...
                        default: _withCtx(() => [
                          ...
                          _cache[39] || (_cache[39] = _createElementVNode("span", null, "新增", -1))
                        ]),
                        _: 1
                      }, 8, ["onClick"]),
                      _createVNode(_component_VBtn, {
        ...
        _createVNode(_component_VWindow, {
          modelValue: activeTab.value,
          "onUpdate:modelValue": _cache[14] || (_cache[14] = $event => ((activeTab).value = $event)),
          touch: false,
            ...
            _createVNode(_component_VWindowItem, { value: "usage" }, {
              default: _withCtx(() => [
                _createVNode(ProviderUsageTable, {
                  ...
                  "max-failures": configValue.value.max_failures || 3,
                  onReset: resetUsage,
                  onSelect: selectProvider,
                  onOpenVendorEdit: openVendorEditFromOverview,
                  onTest: _cache[9] || (_cache[9] = payload => emit('test-provider', payload)),
                  onResetFailures: _cache[10] || (_cache[10] = providerId => emit('reset-failures', providerId))
            ...
            _createVNode(_component_VWindowItem, { value: "config" }, {
              default: _withCtx(() => [
                _createVNode(ProviderConfigTable, {
                  ...
                  onResetFailures: _cache[11] || (_cache[11] = providerId => emit('reset-failures', providerId))
            ...
            _createVNode(_component_VWindowItem, { value: "vendors" }, {
              default: _withCtx(() => [
                _createVNode(VendorManager, {
                  ...
                  onRefresh: _cache[12] || (_cache[12] = $event => (emit('refresh'))),
                  onDragModeChange: _cache[13] || (_cache[13] = $event => (vendorDragMode.value = $event))
    ...
    _createVNode(ProviderEditorDialog, {
      ...
      "onUpdate:modelValue": _cache[15] || (_cache[15] = $event => ((showEditor).value = $event)),
      "retain-focus": false,
      ...
      onQueryModels: _cache[16] || (_cache[16] = payload => emit('query-models', payload)),
      onTestConnection: _cache[17] || (_cache[17] = payload => emit('test-connection', payload))
    }, null, 8, ["modelValue", "provider", "editor-index", "existing-providers", "vendors"]),
    _createVNode(_component_VDialog, {
      modelValue: showDeleteProviderConfirm.value,
      "onUpdate:modelValue": _cache[19] || (_cache[19] = $event => ((showDeleteProviderConfirm).value = $event)),
      "max-width": "420",
      persistent: ""
    }, {
      default: _withCtx(() => [
        _createVNode(_component_VCard, null, {
          default: _withCtx(() => [
            ...
            _createVNode(_component_VCardText, null, {
              default: _withCtx(() => [
                _cache[50] || (_cache[50] = _createTextVNode(" 确定要删除供应商「", -1)),
                _createElementVNode("strong", null, _toDisplayString(deleteProviderName.value), 1),
                _cache[51] || (_cache[51] = _createTextVNode("」吗？此操作不可撤销。 ", -1))
              ]),
              _: 1
            }),
            _createVNode(_component_VCardActions, { class: "d-flex justify-end ga-2" }, {
              default: _withCtx(() => [
                _createVNode(_component_VBtn, {
                  variant: "text",
                  onClick: _cache[18] || (_cache[18] = $event => (showDeleteProviderConfirm.value = false))
                }, {
...
const AgentTokensManager = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-366d83a4"]]);
