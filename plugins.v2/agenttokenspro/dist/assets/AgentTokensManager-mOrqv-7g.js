...
const _hoisted_3$4 = ["draggable", "onClick", "onDragstart", "onDragover", "onDrop"];
const _hoisted_4$4 = { class: "drag-col text-center" };
  ...
  return (_openBlock$4(), _createBlock$4(_component_VSheet, {
    ...
    default: _withCtx$4(() => [
      _createElementVNode$4("div", {
        class: _normalizeClass$1(["provider-table-scroll", { 'is-drag-mode': __props.dragMode }])
      }, [
        _createVNode$4(_component_VTable, { density: "comfortable" }, {
          default: _withCtx$4(() => [
            _createElementVNode$4("thead", null, [
              _createElementVNode$4("tr", null, [
                _cache[3] || (_cache[3] = _createElementVNode$4("th", { class: "drag-col" }, null, -1)),
                _cache[4] || (_cache[4] = _createElementVNode$4("th", { class: "select-col" }, null, -1)),
                _cache[5] || (_cache[5] = _createElementVNode$4("th", null, "启用", -1)),
                ...
                (__props.showCredentials)
                  ? (_openBlock$4(), _createElementBlock$3("th", _hoisted_1$4, "地址"))
                  : _createCommentVNode$3("", true),
                (__props.showCredentials)
                  ? (_openBlock$4(), _createElementBlock$3("th", _hoisted_2$4, "Key"))
                  : _createCommentVNode$3("", true),
            ...
            _createElementVNode$4("tbody", null, [
              (_openBlock$4(true), _createElementBlock$3(_Fragment$2, null, _renderList$1(__props.providers, (row, index) => {
                return (_openBlock$4(), _createElementBlock$3("tr", {
                  ...
                  _createElementVNode$4("td", _hoisted_4$4, [
                  ...
                  (__props.showCredentials)
                    ...
                    : _createCommentVNode$3("", true),
                  (__props.showCredentials)
                    ? (_openBlock$4(), _createElementBlock$3("td", _hoisted_7$4, _toDisplayString$4(getMaskedApiKey(row)), 1))
                    : _createCommentVNode$3("", true),
...
const ProviderConfigTable = /*#__PURE__*/_export_sfc(_sfc_main$4, [['__scopeId',"data-v-d28c3e66"]]);
...
const {computed: computed$3,ref: ref$1,watch: watch$1} = await importShared('vue');
...
const ProviderEditorDialog = /*#__PURE__*/_export_sfc(_sfc_main$3, [['__scopeId',"data-v-74c94cd7"]]);
...
const {computed,nextTick,ref,watch} = await importShared('vue');
...
const AgentTokensManager = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-d94abf48"]]);
