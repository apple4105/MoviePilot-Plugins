...
const {computed: computed$5,nextTick,onBeforeUnmount,onMounted: onMounted$1,ref: ref$4,watch: watch$3} = await importShared('vue');
...
// 厂商管理 ref
const vendorRef = ref$4(null);
// 厂商拖拽模式状态（镜像 VendorManager 内部状态）
const vendorDragMode = ref$4(false);
// 移动端判定：UA + 触控 + 窗口宽度
const isMobile = ref$4(false);
// 移动端 Tab 列表
const mobileTabs = [
...
return (_ctx, _cache) => {
  ...
  return (_openBlock$6(), _createElementBlock$5("div", {
    ...
    _createVNode$6(_component_VSheet, {
      ...
      default: _withCtx(() => [
        (isMobile.value)
          ? (_openBlock$6(), _createElementBlock$5("div", _hoisted_14, [
              _createElementVNode("div", _hoisted_15, [
                (_openBlock$6(), _createElementBlock$5(_Fragment, null, _renderList(mobileTabs, (tab) => {
              ...
              _createElementVNode("div", _hoisted_17, [
                (activeTab.value === 'usage')
                  ? (_openBlock$6(), _createElementBlock$5(_Fragment, { key: 0 }, [
                      _createVNode$6(_component_VBtn, {
                        ...
                        default: _withCtx(() => [
                          _createVNode$6(_component_VIcon, { size: "18" }, {
                ...
                (activeTab.value === 'vendors')
                  ? (_openBlock$6(), _createElementBlock$5(_Fragment, { key: 2 }, [
                      _createVNode$6(_component_VBtn, {
                        size: "x-small",
                        variant: "text",
                        color: "primary",
          ...
          : (_openBlock$6(), _createElementBlock$5("div", _hoisted_18, [
...
const AgentTokensManager = /*#__PURE__*/_export_sfc(_sfc_main$6, [['__scopeId',"data-v-c5ded6a3"]]);
